...
import com.sorgs.baseproject.action.StatusAction;
import com.sorgs.baseproject.adapter.PhotoAdapter;
import com.sorgs.baseproject.base.BaseActivity;
import com.sorgs.baseproject.base.BaseAdapter.OnChildClickListener;
import com.sorgs.baseproject.base.BaseAdapter.OnItemClickListener;
import com.sorgs.baseproject.base.BaseAdapter.OnItemLongClickListener;
import com.sorgs.baseproject.dialog.AlbumDialog;
import com.sorgs.baseproject.helper.ActivityStackManager;
import com.sorgs.baseproject.other.GridSpaceDecoration;
import com.sorgs.baseproject.other.IntentKey;
import com.sorgs.baseproject.utils.ToastUtils;
import com.sorgs.baseproject.widget.HintLayout;
 ...
 * desc   : 图片选择
 */
public final class PhotoActivity extends BaseActivity implements StatusAction,
        OnItemClickListener,
        OnItemLongClickListener,
        OnChildClickListener, Runnable {
    ...
    public void onRightClick(View v) {
        ...
        data.add(new AlbumDialog.AlbumBean(mAllPhoto.get(0), getString(R.string.photo_all), mAllPhoto.size(),
                mAdapter.getData() == mAllPhoto));
        ...
        if (childView.getId() == R.id.fl_photo_check) {
            if (mSelectPhoto.contains(mAdapter.getItem(position))) {
                ...
                if (mMaxSelect == 1 && mSelectPhoto.size() == 1) {
                    ...
                    ToastUtils.INSTANCE.showShort(String.format(getString(R.string.photo_max_hint), mMaxSelect));
                }
            }
    ...
    protected void initView(@Nullable Bundle savedInstanceState) {
        ...
        mHintLayout = findViewById(R.id.hl_photo_hint);
        mRecyclerView = findViewById(R.id.rv_photo_list);
        mFloatingView = findViewById(R.id.fab_photo_floating);
        ...
        // 添加分割线
        mRecyclerView.addItemDecoration(new GridSpaceDecoration(
