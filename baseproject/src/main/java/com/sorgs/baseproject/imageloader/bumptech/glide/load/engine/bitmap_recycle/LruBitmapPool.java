 ...
 * eviction policy to evict {@link Bitmap}s from the least recently used bucket in order to keep
...
public class LruBitmapPool implements BitmapPool {
     ...
     *
     * @param maxSize        The initial maximum size of the pool in bytes.
     * @param allowedConfigs A white listed set of {@link Bitmap.Config} that are allowed to be put
