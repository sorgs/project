...
import com.sorgs.baseproject.imageloader.bumptech.glide.load.MultiTransformation;
...
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.UnitTransformation;
...
import com.sorgs.baseproject.imageloader.bumptech.glide.provider.ChildLoadProvider;
...
import com.sorgs.baseproject.imageloader.bumptech.glide.request.GenericRequest;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.Request;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.RequestCoordinator;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.RequestFutureTarget;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.RequestListener;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.ThumbnailRequestCoordinator;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.animation.GlideAnimationFactory;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.animation.NoAnimation;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.animation.ViewAnimationFactory;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.animation.ViewPropertyAnimation;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.animation.ViewPropertyAnimationFactory;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.target.PreloadTarget;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.target.Target;
import com.sorgs.baseproject.imageloader.bumptech.glide.signature.EmptySignature;
 ...
 * @param <DataType>      The data type that the resource
 * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.model.ModelLoader} will provide that
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.model.ModelLoader}, {@link ResourceDecoder}, and
     ...
     * @return This request builder.
     *
     * @see com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.transcode.UnitTranscoder
     * @see com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     */
    ...
    /**
     * Sets an Android resource id for a {@link Drawable} resourceto display while a resource
     * is loading.
     *
     ...
     * impractical to return that size from
     * {@link Target#getSize(com.sorgs.baseproject.imageloader.bumptech.glide.request.target.SizeReadyCallback)}.
     *
     ...
     * @return This request builder.
     *
     * @see com.sorgs.baseproject.imageloader.bumptech.glide.signature.StringSignature
     */
