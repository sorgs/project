...
public interface BitmapDecoder<T> {
     ...
     *                     obtained from the pool other than the bitmap returned by this method should be returned to
     *                     the
     *                     pool.
     ...
     * data while loading the resource. For {@link Bitmap}s this would mean at a minimum doing no
     * downsampling and also probably always producing {@link Bitmap}s with
     * {@link Bitmap.Config#ARGB_8888} as their config.
     * </p>
     */
    String getId();
}
