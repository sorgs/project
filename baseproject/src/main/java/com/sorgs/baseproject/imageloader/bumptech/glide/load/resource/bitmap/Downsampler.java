...
import com.sorgs.baseproject.imageloader.bumptech.glide.util.ByteArrayPool;
import com.sorgs.baseproject.imageloader.bumptech.glide.util.ExceptionCatchingInputStream;
import com.sorgs.baseproject.imageloader.bumptech.glide.util.MarkEnforcingInputStream;
...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    ...
    public static final Downsampler AT_LEAST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_LEAST.com.sorgs.baseproject.imageloader.bumptech.glide.load.data.bitmap";
        }
    };
    /**
    ...
    public static final Downsampler AT_MOST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_MOST.com.sorgs.baseproject.imageloader.bumptech.glide.load.data.bitmap";
        }
    };
    /**
    ...
    public static final Downsampler NONE = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "NONE.com.sorgs.baseproject.imageloader.bumptech.glide.load.data.bitmap";
        }
    };
    ...
    private Bitmap downsampleWithSize(MarkEnforcingInputStream is, RecyclableBufferedInputStream bufferedStream,
                                      BitmapFactory.Options options, BitmapPool pool, int inWidth, int inHeight,
                                      int sampleSize,
     ...
     * @return An integer to pass in to {@link BitmapFactory#decodeStream(InputStream, android.graphics.Rect,
     * BitmapFactory.Options)}.
     *
