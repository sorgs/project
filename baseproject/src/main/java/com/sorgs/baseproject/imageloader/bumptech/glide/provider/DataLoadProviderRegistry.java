...
import com.sorgs.baseproject.imageloader.bumptech.glide.util.MultiClassKey;

import java.util.HashMap;
import java.util.Map;

/**
 * A class that allows {@link DataLoadProvider}s to be registered and retrieved by the
...
public class DataLoadProviderRegistry {
    ...
    /**
     * Registers the given {@link DataLoadProvider} using the given classes so it can later
