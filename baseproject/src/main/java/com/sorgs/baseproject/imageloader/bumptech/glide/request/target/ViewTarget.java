...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
     ...
     * on older versions, be sure to call {@link com.sorgs.baseproject.imageloader.bumptech.glide.Glide#clear(View)}
     * on any view
     ...
     * equal to zero, it then adds an {@link ViewTreeObserver.OnPreDrawListener} which waits until the view
