...
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.DiskCache;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.ExternalCacheDiskCacheFactory;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.LruResourceCache;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.MemoryCache;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.MemorySizeCalculator;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.executor.FifoPriorityThreadPoolExecutor;
...
public class GlideBuilder {
     ...
     * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.Resource}s that are not currently in use.
     *
     ...
     * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.Resource} data on disk.
     *
     ...
     * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.Resource}s that are not already in the cache.
     *
     * <p>
    ...
    /**
     * Sets the {@link ExecutorService} implementation to use when retrieving
     * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.Resource}s that are currently in cache.
     *
     * <p>
     * Any implementation must order requests based on their {@link Priority} for thumbnail
     * requests to work properly.
