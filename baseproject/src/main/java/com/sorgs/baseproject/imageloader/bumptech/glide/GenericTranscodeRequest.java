...
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.transcode.UnitTranscoder;
...
public class GenericTranscodeRequest<ModelType, DataType, ResourceType>
    ...
    GenericTranscodeRequest(Context context, Glide glide, Class<ModelType> modelClass,
                            ModelLoader<ModelType, DataType> modelLoader, Class<DataType> dataClass,
