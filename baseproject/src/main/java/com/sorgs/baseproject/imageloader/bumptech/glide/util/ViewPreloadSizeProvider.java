package com.sorgs.baseproject.imageloader.bumptech.glide.util;

import android.view.View;

import com.sorgs.baseproject.imageloader.bumptech.glide.ListPreloader;
...
public class ViewPreloadSizeProvider<T> implements ListPreloader.PreloadSizeProvider<T>, SizeReadyCallback {
    ...
    /**
     * Constructor that does nothing by default and requires users to call {@link #setView(View)} when a
