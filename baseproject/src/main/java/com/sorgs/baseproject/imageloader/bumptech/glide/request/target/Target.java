...
public interface Target<R> extends LifecycleListener {
     ...
     *
     * <p>
     * Note - This may be called before {@link #onLoadStarted(Drawable)} if the model
     * object is null.
     * </p>
     *
     * @param e             The exception causing the load to fail, or null if no exception occurred (usually because
     *                     a decoder
