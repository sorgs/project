...
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.bitmap.ImageHeaderParser;
...
/**
 * A DataFetcher that retrieves an {@link InputStream} for a local Uri that may or may not be for a resource
 ...
 * thumbs using {@link MediaStore.Images.Thumbnails} and
 * {@link MediaStore.Video.Thumbnails}.
 */
