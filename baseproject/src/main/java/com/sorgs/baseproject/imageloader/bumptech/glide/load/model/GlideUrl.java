 ...
 * {@link #getCacheKey()}. </p>
 *
 * <p> This class can also optionally wrap {@link Headers} for convenience. </p>
 */
public class GlideUrl {
    ...
    public GlideUrl(String url, Headers headers) {
        ...
        if (url != null) {
            ...
            this.stringUrl = "http://giffunnotexists.com/not_exists_image_giffun.jpg";
        }
        this.url = null;
        this.headers = headers;
    }
    ...
    /**
     * Returns a properly escaped {@link URL} that can be used to make http/https requests.
     *
