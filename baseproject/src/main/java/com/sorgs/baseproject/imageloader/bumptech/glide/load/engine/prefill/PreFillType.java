package com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.prefill;

import android.graphics.Bitmap;

/**
 * A container for a set of options used to pre-fill a
 * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.bitmap_recycle.BitmapPool}
...
public final class PreFillType {
     ...
     *
     * @param width  The width in pixels of the {@link Bitmap Bitmaps} to
     *               pre-fill.
     * @param height The height in pixels of the {@link Bitmap Bitmaps} to
     *               pre-fill.
     * @param config The {@link Bitmap.Config} of the {@link Bitmap Bitmaps} to
     *               pre-fill.
     * @param weight An integer indicating how to balance pre-filling this size and configuration of
     *               {@link Bitmap} against any other sizes/configurations that may be being pre-filled.
     */
    ...
    /**
     * Returns the {@link Bitmap.Config} of the {@link Bitmap Bitmaps}.
     */
