...
import com.sorgs.baseproject.imageloader.bumptech.glide.request.target.BaseTarget;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.target.SizeReadyCallback;
 ...
 *
 * <p>
 * Must be set using {@link AbsListView#setOnScrollListener(AbsListView.OnScrollListener)}, or have its
 * corresponding methods called from another {@link AbsListView.OnScrollListener} to function.
 * </p>
 *
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    /**
     * Constructor for {@link ListPreloader} that requires users to subclass and override
     * the {@link #getItems(int, int)} and {@link #getRequestBuilder(Object)} methods.
     *
     * @param maxPreload Maximum number of items to preload.
     * @deprecated Use {@link #ListPreloader(PreloadModelProvider,
     * PreloadSizeProvider, int)} instead. This constructor will be removed in Glide
     * 4.0.
     */
    @Deprecated
     ...
     *              start}
     * @deprecated Use {@link PreloadModelProvider} instead. This method will be
    ...
    /**
     * Returns a non null {@link GenericRequestBuilder} for a given item. Must exactly match the
     ...
     *
     * @deprecated Use {@link PreloadSizeProvider} instead. This method will be removed
     * in Glide 4.0.
     */
    @Deprecated
    ...
    /**
     * Constructor for {@link ListPreloader} that accepts interfaces for providing the dimensions of
    ...
    public interface PreloadModelProvider<U> {
        ...
        /**
         * Returns a non null {@link GenericRequestBuilder} for a given item. Must exactly match
