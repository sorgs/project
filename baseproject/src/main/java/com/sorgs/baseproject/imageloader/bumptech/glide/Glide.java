...
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.Engine;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.bitmap_recycle.BitmapPool;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.DiskCache;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.DiskLruCacheFactory;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.cache.MemoryCache;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.prefill.BitmapPreFiller;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.engine.prefill.PreFillType;
...
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.file_descriptor.FileDescriptorFileLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.file_descriptor.FileDescriptorResourceLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.file_descriptor.FileDescriptorStringLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.file_descriptor.FileDescriptorUriLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.HttpUrlGlideUrlLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.StreamByteArrayLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.StreamFileLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.StreamResourceLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.StreamStringLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.StreamUriLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.StreamUrlLoader;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.bitmap.CenterCrop;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.bitmap.FitCenter;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.bitmap.GlideBitmapDrawable;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.bitmap.ImageVideoDataLoadProvider;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.bitmap.StreamBitmapDataLoadProvider;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.drawable.GlideDrawable;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.file.StreamFileDataLoadProvider;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.gif.GifDrawable;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.gif.GifDrawableLoadProvider;
...
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.transcode.GlideBitmapDrawableTranscoder;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.transcode.ResourceTranscoder;
import com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.transcode.TranscoderRegistry;
import com.sorgs.baseproject.imageloader.bumptech.glide.manager.RequestManagerRetriever;
import com.sorgs.baseproject.imageloader.bumptech.glide.module.GlideModule;
import com.sorgs.baseproject.imageloader.bumptech.glide.module.ManifestParser;
import com.sorgs.baseproject.imageloader.bumptech.glide.provider.DataLoadProvider;
import com.sorgs.baseproject.imageloader.bumptech.glide.provider.DataLoadProviderRegistry;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.FutureTarget;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.Request;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.animation.GlideAnimation;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.target.ImageViewTargetFactory;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.target.Target;
import com.sorgs.baseproject.imageloader.bumptech.glide.request.target.ViewTarget;
...
public class Glide {
     ...
     * models. Typically the
     * {@link RequestManager#using(com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.StreamModelLoader)} or
     * {@link RequestManager#using(com.sorgs.baseproject.imageloader.bumptech.glide.load.model.file_descriptor.FileDescriptorModelLoader)} syntax is
     ...
     * @see RequestManager#using(com.sorgs.baseproject.imageloader.bumptech.glide.load.model.file_descriptor.FileDescriptorModelLoader)
     * @see RequestManager#using(com.sorgs.baseproject.imageloader.bumptech.glide.load.model.stream.StreamModelLoader)
     */
     ...
     * {@link  com.sorgs.baseproject.imageloader.bumptech.glide.load.ResourceDecoder}s and
     * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.Transformation}s. Use
