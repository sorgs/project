package com.sorgs.baseproject.imageloader.bumptech.glide.module;

import android.content.Context;

import com.sorgs.baseproject.imageloader.bumptech.glide.Glide;
import com.sorgs.baseproject.imageloader.bumptech.glide.GlideBuilder;

/**
 * An interface allowing lazy configuration of Glide including setting options using
 * {@link GlideBuilder} and registering
 * {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p>
 ...
 * {@link Glide#register(Class, Class, com.sorgs.baseproject.imageloader.bumptech.glide.load.model.ModelLoaderFactory)}
 * for each {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * com.sorgs.baseproject.imageloader.bumptech.glide.samples.flickr
 *                      .FlickrGlideModule
 *                  }
 *              </pre>
 * </li>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="com.sorgs.baseproject.imageloader.bumptech.glide.samples.flickr
 *                          .FlickrGlideModule"
