 ...
 * {@link Bitmap} or an {@link com.sorgs.baseproject.imageloader.bumptech.glide.load.resource.gif.GifDrawable} into an
...
public class GifBitmapWrapperDrawableTranscoder implements ResourceTranscoder<GifBitmapWrapper, GlideDrawable> {
    ...
    @Override
    public String getId() {
        return "GifBitmapWrapperDrawableTranscoder.com.sorgs.baseproject.imageloader.bumptech.glide.load.resource" +
                ".transcode";
    }
}
