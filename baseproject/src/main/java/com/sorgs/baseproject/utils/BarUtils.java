...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        if (SorgsOptions.Companion.getMStatusHeight() <= 0) {
            Resources resources = SorgsOptions.mContext.getResources();
            int resourceId = resources.getIdentifier("status_bar_height", "dimen", "android");
            return resources.getDimensionPixelSize(resourceId);
        } else {
            return SorgsOptions.Companion.getMStatusHeight();
        }
    }
    ...
    public static int getActionBarHeight() {
        ...
        if (SorgsOptions.mContext.getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, SorgsOptions.mContext.getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = SorgsOptions.mContext.getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = SorgsOptions.mContext.getResources();
