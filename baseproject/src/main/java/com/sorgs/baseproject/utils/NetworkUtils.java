...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        SorgsOptions.mContext.startActivity(
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) SorgsOptions.mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (manager == null) {
            return null;
        }
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) SorgsOptions.mContext.getSystemService(Context.TELEPHONY_SERVICE);
            if (tm == null) {
                return false;
            }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) SorgsOptions.mContext.getSystemService(Context.WIFI_SERVICE);
