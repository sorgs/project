...
import com.sorgs.baseproject.other.PickerLayoutManager;
    ...
    public static final class Builder extends UIDialog.Builder<Builder>
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.tv_ui_confirm) {
                autoDismiss();
                if (mListener != null) {
                    mListener.onSelected(getDialog(), mStartYear + mYearManager.getPickedPosition(), mMonthManager.getPickedPosition() + 1,
